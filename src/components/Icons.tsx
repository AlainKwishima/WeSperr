...
export const ChatIcon = ({ className, mini = true }: IconProps) =>
  mini ? (
    <svg
...
export const PhoneIcon = ({ className }: IconProps) => (
  ...
  >
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M3 5.25c0-1.243 1.007-2.25 2.25-2.25h13.5c1.243 0 2.25 1.007 2.25 2.25v13.5c0 1.243-1.007 2.25-2.25 2.25H5.25C4.007 21 3 19.993 3 18.75V5.25z"
    />
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M8.25 15.75h7.5m-7.5-3h7.5m-7.5-3h7.5"
    />
  </svg>
);
...
export function FluentEmojiFlatHeartSuit(props: SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      <path
        fill={props.fill ? props.fill : "#F8312F"}
